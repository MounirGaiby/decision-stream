#!/usr/bin/env python3
"""
Multi-Model Ensemble Training for Fraud Detection
...
def main():
    print_section("ENSEMBLE MODEL TRAINING - FRAUD DETECTION")
    ...
    # Step 6: Save ensemble metadata
    print("💾 Step 6: Saving Ensemble Metadata...")
    metadata_path = "/app/models/ensemble_metadata.txt"
    with open(metadata_path, "w") as f:
        f.write("Ensemble Fraud Detection Models\n")
        f.write("=" * 50 + "\n\n")
    ...
    print("   2. Start ensemble ML processor: just run-ensemble")
    print("   3. Check ensemble predictions: just check-ensemble")
    print()
