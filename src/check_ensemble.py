#!/usr/bin/env python3
"""
Ensemble System Monitoring Script
Shows statistics for ensemble predictions, model agreement, and flagged transactions
"""
...
def main():
    ...
    print_section("ENSEMBLE FRAUD DETECTION - System Statistics")
    ...
    if transactions_count == 0:
        ...
        print("   2. Ensemble processor is running: just run-ensemble")
        print()
        return
    ...
    if ensemble_count > 0:
        print_section("Ensemble Predictions")
    ...
    if ensemble_count > 0:
        ...
        print("   All 3 ML models are working in ensemble mode")
        print(f"   High-risk transactions are being flagged ({flagged_count} so far)")
    else:
        print("⚠️  System Status: Waiting for ensemble predictions")
        print("💡 Run: just run-ensemble")
